...
class Event(AuditFields):
    ...
    event_uid = models.CharField(max_length=256, null=True, blank=True, verbose_name="Event UID")
    name = models.CharField(max_length=255)
    image = models.ImageField(upload_to="event_thumbnails/", null=True, blank=True)
    ...
    host = models.ForeignKey(Artist, on_delete=models.SET_NULL, null=True, related_name="hosted_events")
    crew = models.ManyToManyField(Artist, related_name="event_crews", blank=True)
